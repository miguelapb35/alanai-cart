...
export default function useAlan() {
  ...
  const openCart = useCallback(() => {
    if (isCartEmpty) {
      alanInstance.playText("It seems like you have no items in your cart");
    } else {
      alanInstance.playText("I am openning the cart for you");
  ...
  const purchaseItems = useCallback(() => {
    if (isCartEmpty) {
      ...
      alanInstance.playText("Checkin out");
      checkout();
    }
